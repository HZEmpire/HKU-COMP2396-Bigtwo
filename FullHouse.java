/**
 * The FullHouse class is a subclass of the Hand class and is used to model a hand of FullHouse. It has method and
 * variables which Hand has. Also it implement abstract methods in hand which are use to check if it is a valid
 * FullHouse and get the Type of it and get how large it is in same type hands.
 * 
 * @author Xu Haozhou
 * @version 1.0
 */
public class FullHouse extends Hand{
    ...
    /**
     * Method for checking if it is a valid FullHouse hands.
     * 
    ...
    public boolean isValid(){
        ...
        if ((countsecond == 3 && countfirst == 2) || (countsecond == 2 && countfirst == 3)){
     ...
     * 
     * @return The value to represent how large it is in FullHouse.
     */
    public int getLarge(){
        return this.large;
    }
